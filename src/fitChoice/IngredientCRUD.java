...
public class IngredientCRUD extends Application {
    VBox mainContainer;
    GridPane grid;
    VBox box;
    HBox btnBox;
    ...
    public VBox CRUDForm() {
        ...
        Label ingridientsLabel = new Label("Ingridients");
        ingridientsLabel.setFont(Font.font("Arial", FontWeight.BOLD, 20));

        Label ingridientsNameLabel = new Label("Ingridient Name:");
        TextField ingridientsNameField = new TextField();

        // Action Buttons
        Button addButton = new Button("Add Ingridients");
        Button updateButton = new Button("Update Ingrients");
        Button deleteButton = new Button("Delete Ingridients");
        ...
        grid.add(ingridientsLabel, 0, 0);

        grid.add(ingridientsNameLabel, 0, 1);
        grid.add(ingridientsNameField, 0, 2);

        box.getChildren().addAll(grid, btnBox);
        bp.setLeft(box);

        VBox ingridientsFormContainer = new VBox(grid, btnBox);
        ingridientsFormContainer.setSpacing(10);

        return ingridientsFormContainer;
    }
    ...
    public VBox tableProduct() {
        ...
        TableColumn<String, String> ingridientsIDColumn = new TableColumn<>("ID");
        TableColumn<String, String> ingridientsNameColumn = new TableColumn<>("Ingridients");
        TableColumn<String, String> productColumn = new TableColumn<>("Products");

        table.getColumns().addAll(ingridientsIDColumn, ingridientsNameColumn, productColumn);
    ...
    public void start(Stage stage) throws Exception {
        ...
        stage.setTitle("Ingridients CRUD");
        stage.show();
    }
